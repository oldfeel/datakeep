...
object Constants {
    ...
    // 服务状态
    const val ACTION_RESTART = "tech.shuipi.syncthing.service.SyncthingService.RESTART"
    const val ACTION_RESET_DATABASE = "tech.shuipi.syncthing.service.SyncthingService.RESET_DATABASE"
    const val ACTION_RESET_DELTAS = "tech.shuipi.syncthing.service.SyncthingService.RESET_DELTAS"
